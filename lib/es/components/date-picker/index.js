...
var DatePicker = forwardRef(function (_a, ref) {
  var visable = _a.visable,
      ...
      value = _a.value;
  var classes = Classnames(datePickerClassPrefix, "show");
  return React.createElement(React.Fragment, null, visable && React.createElement("div", {
    className: classes,
    ref: ref
...
function useDatePicker() {
  ...
  var wrapper = useCallback(function (_a) {
    var _b = _a === void 0 ? {} : _a,
        _c = _b.precision,
        precision = _c === void 0 ? "day" : _c,
        onConfirm = _b.onConfirm,
        _d = _b.value,
        value = _d === void 0 ? new Date() : _d;
