...
var generateWeekColumns = function (selected, precision) {
  ...
  var year = (_a = selected[0]) !== null && _a !== void 0 ? _a : dayjs().year() - 10;
  var currentYear = dayjs().year();
  var rank = precisionWeekLengthRecord[precision];
  var selectedYearWeek = dayjs("".concat(year, "-01-01")).isoWeeksInYear();
  var res = [];
...
var generateDateColumns = function (selected, precision) {
  ...
  var res = [];
  var maxDay = dayjs("".concat(year, "-").concat(month, "-1")).daysInMonth();
...
export function generateDatePickerColumns(selected, precision) {
...
export function convertNumberArrayToDate(value) {
  var _a, _b, _c, _d, _e, _f;

  var year = (_a = value[0]) !== null && _a !== void 0 ? _a : dayjs().year() - 20;
...
export function convertDateToNumberArray(date) {
  if (!date) return [];
  return [date.getFullYear(), date.getMonth() + 1, date.getDate(), date.getHours(), date.getMinutes(), date.getSeconds()];
}
export function convertNumberArrayToWeek(value) {
  var _a, _b, _c;

  var year = (_a = value[0]) !== null && _a !== void 0 ? _a : dayjs().year() - 20;
  var week = (_b = value[1]) !== null && _b !== void 0 ? _b : 1;
  var weekday = (_c = value[2]) !== null && _c !== void 0 ? _c : 1;
  var day = dayjs().year(year).isoWeek(week).isoWeekday(weekday).hour(0).minute(0).second(0);
  return day.toDate();
}
export function convertWeekToNumberArray(date) {
  if (!date) return [];
  var day = dayjs(date);
